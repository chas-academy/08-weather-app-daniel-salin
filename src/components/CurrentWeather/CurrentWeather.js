...
export default function Current(props) { 
    ...
    return (  
    	<div className="m-0 p-2 row text-center bg-primary text-light">
    	  <div className="col-sm-4 col-xs-4 text-center" style={{fontSize:"2em", alignSelf:"center"}}>
    	      {weather.temperature} {(unitType==="Metric")? "°C" : "°F"}
    	  </div>
    	  <div className="col-sm-4 col-xs-4" style={{fontSize:"2em", alignSelf:"center"}}>
    	      <WeatherIcon desc={weather.summary} size="large" icon={weather.icon}/>
    		</div>
    	  <div className="col-sm-4 col-xs-12 text-center" style={{alignSelf:"center"}}>
